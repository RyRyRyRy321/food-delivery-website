    ...
    return (
            ...
            <div className='max-w-sm shadow rounded-2xl flex flex-col shadow'>
                ...
                <div className="flex flex-row">
                    ...
                    <div className="flex items-center mt-7 me-5">
                            <svg className = "me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
